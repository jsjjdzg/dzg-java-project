        ...
        <nav class="navbar navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    <a href="${request.contextPath}/" class="navbar-brand"><b>DZG Code Generator</b></a>
...
<#macro commonFooter >
    <footer class="main-footer">
        <div class="container">
            Powered by <b>DZG Code Generator</b> v0.0.1
            <div class="pull-right hidden-xs">
                <strong>Infonity &copy; ${.now?string('yyyy')} &nbsp;
                    <a href="https://github.com/jsjjdzg/dzg-code-generator" target="_blank">github</a>
